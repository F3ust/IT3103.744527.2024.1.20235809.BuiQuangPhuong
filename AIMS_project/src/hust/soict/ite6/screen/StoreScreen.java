...
public class StoreScreen extends JFrame {
    ...
    public StoreScreen(Store store) {
        ...
        cp.add(center = createCenter(store.getItemsAvailable()), BorderLayout.CENTER);
            ...
            public void changedUpdate(DocumentEvent e) {
                if (btnByTitle.isSelected() || btnByCategory.isSelected()) {
                    ...
                    FilteredList<Media> filteredList = new FilteredList<>(
                            FXCollections.observableArrayList(store.getItemsAvailable()));
    ...
    public void loadItemsToStore() {
        loadItemsToStore(store.getItemsAvailable());
    }
